...
export default function ProjectGridShowcase({ images = [] }) {
  return (
    <div className="relative h-full w-full">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-[-35deg] grid grid-cols-4 grid-rows-4 items-center justify-items-center gap-8 h-[200%] aspect-square">
