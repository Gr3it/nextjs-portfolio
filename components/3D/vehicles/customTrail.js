...
const Trail = React.forwardRef(function Trail(props, forwardRef) {
  ...
  const mat = React.useMemo(() => {
    ...
    if (
      typeof ((_matOverride = matOverride) == null
        ? void 0
        : _matOverride.props) === "object" &&
      ((_matOverride2 = matOverride) == null ? void 0 : _matOverride2.props) !==
        null
    ) {
