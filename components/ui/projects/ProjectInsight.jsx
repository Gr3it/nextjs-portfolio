...
export default function ProjectInsight({
  ...
  return (
    <div
      className={`h-full p-8 rounded-3xl bg-[var(--hoverBg)] border border-[var(--borderColor)] hover:border-[var(--accent-color)] transition-all duration-300 group ${className}`}
    >
      {Icon && (
